...
Discord and GitHub provide built-in search features, both for the server, and for each forum / discussion. For Discord, the server-wide search is much more feature complete, and is the one we'd recommend using.
