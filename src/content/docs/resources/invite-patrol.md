...
- Helping in channels like `#general`, `#starlight`, `#framework`, `#integration`, etc.
- Helping in Astro repos with issues and PRs
- Helping outside of the Astro community in places like Stack Overflow, Twitter/X/Bluesky, Mastodon, Reddit, Twitch/Youtube streams, etc.

## Nominating

If you are in `@support-patrol` and you have noticed someone actively helping others you can invite them to the role.

To nominate someone, create a thread in the `#support-squad` channel nominating the person, for example: 

> I want to nominate `@[name]` for `@support-patrol`, they have been really great at helping people in `#support` threads!

Create a poll with three options: Agree (👍), Abstain (😐), Disagree (👎) that lasts for a week.
